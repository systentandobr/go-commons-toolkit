...
import (
	...
	"github.com/systentandobr/toolkit/go/internal/domain/{{.DomainName}}/entity"
)
...
import (
	...
	"github.com/systentandobr/toolkit/go/internal/domain/{{.DomainName}}/entity"
	"github.com/systentandobr/toolkit/go/internal/domain/{{.DomainName}}/repository"
)
...
require (
	...
	github.com/systentandobr/toolkit/go v0.1.0
)
`,
		"makefile": `# Variáveis
